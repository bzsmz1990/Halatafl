...
describe('Halatafl', function() {
    ...
    function expectPiece(row, col, pieceKind) {
        ...
        if (pieceKind == 'F')
            ...
            expect(getImg(row, col).getAttribute("src")).toEqual(
                "http://localhost:9000/imgs/fox_selected.png");
        else if (pieceKind == 'S')
            expect(getImg(row, col).getAttribute("src")).toEqual(
                "http://localhost:9000/imgs/sheep.png");
        else if (pieceKind == 'S_trans')
            expect(getImg(row, col).getAttribute("src")).toEqual(
                "http://localhost:9000/imgs/sheep_selected.png");
        else if (pieceKind == '' || pieceKind == 'X')
            expect(getImg(row, col).getAttribute("src")).toEqual(
                "http://localhost:9000/imgs/empty.png");
    }

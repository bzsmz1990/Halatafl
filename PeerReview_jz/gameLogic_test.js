...
describe("Halatafl", function() {
    ...
    it("moving fox when it's sheep's turn is illegal", function () {
        expectIllegalMove(0, {board:[
                ...
                ['X', 'X', 'S', 'S', 'S', 'X', 'X'],
                ['X', 'X', 'S', 'S', 'S', 'X', 'X']],
                delta:{rowBefore: 0, colBefore: 2, rowAfter: 1, colAfter: 3}
            }, [
            {setTurn: {turnIndex: 1}},
            {set: {key: 'board', value: [
                ['X', 'X', '', '', 'F', 'X', 'X'],
    ...
    it("moving sheep when it's fox's turn is illegal", function () {
        expectIllegalMove(1, {board:[
                ...
                ['X', 'X', 'S', 'S', 'S', 'X', 'X'],
                ['X', 'X', 'S', 'S', 'S', 'X', 'X']],
                delta:{rowBefore: 2, colBefore: 2, rowAfter: 2, colAfter: 3}},
            [{setTurn: {turnIndex: 0}},
             {set: {key: 'board', value: [
                 ['X', 'X', '', '', 'F', 'X', 'X'],
                 ['X', 'X', '', 'F', '', 'X', 'X'],
    ...
    it("moving a fox to a non-existent vertex is illegal", function () {
        expectIllegalMove(1,
            {board:[
                ...
                ['X', 'X', 'S', 'S', 'S', 'X', 'X'],
                ['X', 'X', 'S', 'S', 'S', 'X', 'X']],
                delta:{rowBefore: 2, colBefore: 2, rowAfter: 2, colAfter: -1}},
            [{setTurn: {turnIndex: 0}},
             {set: {key: 'board', value: [
                 ['X', 'X', '', '', '', 'F', 'X'],
                 ['X', 'X', '', 'F', '', 'X', 'X'],
